...
@dataclass
class LARSConfig(PeftConfig):
    """
    Description To Be Re-Done
    ...
    target_modules: Optional[Union[list[str], str]] = field(
        ...
        metadata={
            "help": (
                "List of module names or regex expression of the module names to replace with LARS."
    ...
    modules_to_save: Optional[list[str]] = field(
        default=None,
        metadata={
            "help": "List of modules apart from LARS layers to be set as trainable and saved in the final checkpoint. "
            "For example, in Sequence Classification or Token Classification tasks, "
            "the final layer `classifier/score` are randomly initialized and as such need to be trainable and saved."
        },
    )
    init_lars_weights: bool = field(
        default=True,
        metadata={"help": "Whether to initialize the vectors in the LARS layers."},
    )
